...
from tensorflow.python.keras.callbacks import EarlyStopping,Theia
batch_size = 10
epoch = 30
...
history_cnn = cnn.fit(x_train, y_train, epochs=epoch, batch_size=batch_size,
                validation_data=(x_test, y_test),verbose=0,callbacks=[Theia(x_train,x_test,batch_size,1,0)])